          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:info@pncreators.com" className="hover:text-purple-400 transition">info@pncreators.com</a>
              </li>
              <li className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-400 mb-1">Our latest insights on web development trends.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-purple-600 transition" title="Dribbble">
